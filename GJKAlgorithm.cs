...
public static class ClosestPointAlgorithm
{
    ...
    /// <returns></returns>
    public static (Vector2, Vector2) ClosestPointByGJK(Poly poly1, Poly poly2)
    {
        ...
        while (true)
        {
            ...
            for (int i = 0; i < prePoly1.Count; ++i)
            {
                ...
                {
                    if (simplex.count == 1)
                        return (simplex.vertexA.poly1, simplex.vertexA.poly2);
                    else
...
public class ClosestPoint : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        (var p1, var p2) = ClosestPointAlgorithm.ClosestPointByGJK(new Poly(poly1), new Poly(poly2));
        if (p1 == p2)
        {
